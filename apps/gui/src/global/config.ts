...
export const zConfig = z.object({
  ...
  defaultAwardsQuerySize: z.coerce.number().int().gt(0).default(50),
...
const defaultAwardsQuerySize = import.meta.env.VITE_DEFAULT_AWARDS_QUERY_SIZE;
